...
!(function (t, e) {
  ...
  function I(t, e) {
    e.useNativeTimers
      ...
      : ((t.setTimeoutFn = setTimeout.bind(L)), (t.clearTimeoutFn = clearTimeout.bind(L)))
  }
  var D,
    F = (function (t) {
      o(r, t)
        ...
        r(i, [
          {
            ...
            value: function (t, e, n) {
              return (
                d(s(i.prototype), 'emitReserved', this).call(this, 'error', new F(t, e, n)), this
              )
            },
          },
          {
          ...
          },
          {
            key: 'onPacket',
            value: function (t) {
              d(s(i.prototype), 'emitReserved', this).call(this, 'packet', t)
            },
          },
          {
            key: 'onClose',
            value: function (t) {
              ;(this.readyState = 'closed'),
                d(s(i.prototype), 'emitReserved', this).call(this, 'close', t)
            },
          },
        ]),
        i
        ...
        r(s, [
          ...
          },
          {
            ...
            value: function () {
              var t = this.query || {},
                ...
                n = ''
              !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = z()),
          ...
          },
          {
            ...
            value: function () {
              ...
              return i(t, { xd: this.xd, xs: this.xs }, this.opts), new et(this.uri(), t)
            },
          },
          {
            key: 'doWrite',
              ...
              try {
                ...
                try {
                  if (this.opts.extraHeaders)
                    for (var r in (n.setDisableHeaderCheck && n.setDisableHeaderCheck(!0),
  ...
  if (((et.requestsCount = 0), (et.requests = {}), 'undefined' != typeof document))
    if ('function' == typeof attachEvent) attachEvent('onunload', nt)
    else if ('function' == typeof addEventListener) {
      addEventListener('onpagehide' in L ? 'pagehide' : 'unload', nt, !1)
    }
  function nt() {
    for (var t in et.requests) et.requests.hasOwnProperty(t) && et.requests[t].abort()
  }
  var rt =
      ...
      return (
        r(i, [
          ...
          },
          {
            ...
            value: function () {
              if (this.check()) {
                ...
                try {
                  this.ws = ot ? new it(t, e, n) : e ? new it(t, e) : new it(t)
                } catch (t) {
          ...
          },
          {
            ...
            value: function () {
              ...
              this.opts.port &&
                ...
                (n = ':' + this.opts.port),
                this.opts.timestampRequests && (t[this.opts.timestampParam] = z()),
          ...
          },
          {
            key: 'check',
            value: function () {
              return !(!it || ('__initialize' in it && this.name === i.prototype.name))
            },
          },
        ]),
        i
  ...
  function ht(t) {
    ...
    for (var i, o, s = ct.exec(t || ''), a = {}, c = 14; c--; ) a[ut[c]] = s[c] || ''
    return (
      -1 != n &&
        -1 != r &&
        ((a.source = e),
  ...
  var lt = 'function' == typeof ArrayBuffer,
    ...
    dt =
      'function' == typeof Blob ||
      ('undefined' != typeof Blob && '[object BlobConstructor]' === pt.call(Blob)),
    yt =
      'function' == typeof File ||
      ('undefined' != typeof File && '[object FileConstructor]' === pt.call(File))
  function vt(t) {
    return (
      (lt &&
  ...
  function gt(e, n) {
    ...
    for (var o in e) if (Object.prototype.hasOwnProperty.call(e, o) && gt(e[o])) return !0
    return !1
  }
  function mt(t) {
    var e = [],
  ...
  function wt(e, n) {
    ...
    if (Array.isArray(e)) for (var r = 0; r < e.length; r++) e[r] = wt(e[r], n)
    else if ('object' === t(e))
      for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = wt(e[i], n))
    return e
  }
  var _t
  !(function (t) {
        ...
        r(t, [
          {
            ...
            value: function (t) {
              return (t.type !== _t.EVENT && t.type !== _t.ACK) || !gt(t)
                ...
                : ((t.type = t.type === _t.EVENT ? _t.BINARY_EVENT : _t.BINARY_ACK),
          ...
          [
            {
              ...
              value: function (t) {
                var e
                if ('string' == typeof t)
                  (e = this.decodeString(t)).type === _t.BINARY_EVENT || e.type === _t.BINARY_ACK
                    ? ((this.reconstructor = new Ot(e)),
                      0 === e.attachments &&
                        d(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e))
                    : d(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e)
                else {
                  if (!vt(t) && !t.base64) throw new Error('Unknown type: ' + t)
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (void 0 === _t[n.type]) throw new Error('unknown packet type ' + n.type)
                if (n.type === _t.BINARY_EVENT || n.type === _t.BINARY_ACK) {
      ...
      return (
        r(i, [
          ...
          },
          {
            key: 'emit',
            value: function (t) {
              if (Ct.hasOwnProperty(t)) throw new Error('"' + t + '" is a reserved event name')
              for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
                n[r - 1] = arguments[r]
              n.unshift(t)
